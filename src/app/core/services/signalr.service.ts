...
export class SignalRService {
  ...
  public sendMessage(roomCode: string, message: string, senderId: string, senderName: string) {
    this.hubConnection.invoke('SendMessage', roomCode, message, senderId, senderName);
  }
